...
Процедура УстановитьОтбор()
	...
	//++ 17.04.2018 Веденеев П. //добавление отборов по бизнес-процессу
...
Процедура УстановитьОтборСписка(Список, ПараметрыОтбора)
	...
	//++ 17.04.2018 Веденеев П. //добавление отборов по бизнес-процессу
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
		Список, "БизнесПроцесс", ПараметрыОтбора["БизнесПроцесс"], , , ЗначениеЗаполнено(ПараметрыОтбора["БизнесПроцесс"]));
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
		Список, "ТочкаМаршрута", ПараметрыОтбора["ТочкаМаршрута"], , , ЗначениеЗаполнено(ПараметрыОтбора["ТочкаМаршрута"]));
	//-- 17.04.2018 Веденеев П. //добавление отборов по бизнес-процессу
...
Процедура БизнесПроцессПриИзменении(Элемент)
	 ...
	 УстановитьСписокВыбораТочекМаршрута();
...
&НаСервере
Процедура УстановитьСписокВыбораТочекМаршрута()
	
	Элементы.ТочкаМаршрута.СписокВыбора.Очистить();
	
	Если ЗначениеЗаполнено(БизнесПроцесс) Тогда
		
		БизнесПроцессМенеджер = БизнесПроцессы[БизнесПроцесс.Метаданные().Имя];
		
		Для каждого ТочкаМаршрута Из БизнесПроцессМенеджер.ТочкиМаршрута Цикл
			
			Если ТочкаМаршрута.Вид = ВидТочкиМаршрутаБизнесПроцесса.Действие Тогда
				
				Элементы.ТочкаМаршрута.СписокВыбора.Добавить(ТочкаМаршрута);
...
&НаКлиенте
Процедура БизнесПроцессОчистка(Элемент, СтандартнаяОбработка)
