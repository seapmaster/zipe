...
&НаКлиенте
Асинх Процедура ВыполнитьЗагрузкуДанных()
	...
	Пока НаборЗаписей.EOF()=0 Цикл
		...
		Иначе
			...
			СтрокаТаблицыКартинок.ФайлСуществует = Ждать ФайлКартинки.СуществуетАсинх();
...
&НаКлиенте
Асинх Процедура ВыполнитьЗаписьДанных()
	...
	Для каждого СтрокаКартинка Из КартинкиПредметовСнабжения Цикл
		...
		Если СтрокаКартинка.ФайлСуществует Тогда
			...
			РезультатПоместить = Ждать ПоместитьФайлыНаСерверАсинх(,,ПомещаемыеФайлы, ЭтаФорма.УникальныйИдентификатор);
			...
			ПрисоединенныйФайл = ПрисоединенныеФайлыСлужебныйВызовСервера.ДобавитьФайл(СтрокаКартинка.ПредметСнабжения,
									...
									,
									Ждать ФайлКартинки.ПолучитьУниверсальноеВремяИзмененияАсинх(),
...
&НаКлиенте
Асинх Процедура ПослеПомещенияКартинокМурена (ПомещенныеФайлы, ДополнительныеПараметры) Экспорт
