...
Процедура ВыбратьВидСравнения()
	...
	Если HighPerfomance Тогда
		...
		Для каждого ВариантСравнения Из СтрокаТаблицы.ВариантыСравнения Цикл
		
			Если Не ВариантСравнения.Значение = "Подобно" Тогда
			
				СписокВыбора.Добавить(ВариантСравнения.Значение, ВариантСравнения.Представление);		
