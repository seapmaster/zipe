...
Процедура ВыполнитьПриСозданииЗадач(ТочкаМаршрутаБизнесПроцесса, ФормируемыеЗадачи, Отказ)
	...
	ТочкиБП = БизнесПроцессы.ОтправкаВКСУНСИНаПоискПоКоду.ТочкиМаршрута; 
	ВариантыВыбора = "";
...
Процедура ВыборВарианта1ОбработкаВыбораВарианта(ТочкаВыбораВарианта, Результат)
	...
	Запрос.УстановитьПараметр("БизнесПроцесс", Ссылка);
	Запрос.УстановитьПараметр("ТочкаМаршрута", БизнесПроцессы.ОтправкаВКСУНСИНаПоискПоКоду.ТочкиМаршрута.ПолучениеДанныхСпециалистом);
...
Процедура ВыборВарианта2ОбработкаВыбораВарианта(ТочкаВыбораВарианта, Результат)
	...
	Запрос.УстановитьПараметр("БизнесПроцесс", Ссылка);
	Запрос.УстановитьПараметр("ТочкаМаршрута", БизнесПроцессы.ОтправкаВКСУНСИНаПоискПоКоду.ТочкиМаршрута.ПолучениеДанныхРуководителем);
