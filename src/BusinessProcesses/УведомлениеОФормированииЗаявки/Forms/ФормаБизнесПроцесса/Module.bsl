...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Объект.Ссылка.Пустая() Тогда
		...
		Если Параметры.Свойство("ПакетЗаявок") Тогда
			Объект.Предмет = Параметры.ПакетЗаявок;
		КонецЕсли; 
		
		Объект.Наименование = "Уведомление о формировании заявки";
		Объект.Исполнитель  = Справочники.РолиИсполнителей.РуководительПроектаВТС;
...
Процедура ИнициализацияФормы()
	...
	Если ОбъектСтартован(ЭтаФорма) Тогда
