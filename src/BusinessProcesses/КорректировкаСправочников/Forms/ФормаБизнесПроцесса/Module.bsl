...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ДанныеБизнесПроцесса", ДанныеБизнесПроцесса) Тогда
		...
		Для каждого ЭлементДанных Из ДанныеБизнесПроцесса Цикл
			
			Объект[ЭлементДанных.Ключ] = ЭлементДанных.Значение;
	...
	Если Параметры.Свойство("ЗначенияРеквизитов", ЗначенияРеквизитов) Тогда
		
		НовыеЗначения = ЗначенияРеквизитов.НовыеЗначения;
		СтарыеЗначения = ЗначенияРеквизитов.СтарыеЗначения;
		
		Для каждого ЗначениеРеквизита Из НовыеЗначения Цикл
			
			СтрокаТЧ = Объект.РеквизитыСправочника.Добавить();
			СтрокаТЧ.ИмяРеквизита = ЗначениеРеквизита.Ключ;
			СтрокаТЧ.НовоеЗначение = ЗначениеРеквизита.Значение;
			СтрокаТЧ.СтароеЗначение = СтарыеЗначения[ЗначениеРеквизита.Ключ];
			СтрокаТЧ.ОтображаемоеСтароеЗначение = СтрокаТЧ.СтароеЗначение;
	...
	Если Не Объект.Завершен Тогда
		...
		ЗаполнитьОтображаемыеСтарыеЗначенияРеквизитов();
...
&НаСервере
Процедура ЗаполнитьОтображаемыеСтарыеЗначенияРеквизитов()
	
	Для каждого СтрокаТЧ Из Объект.РеквизитыСправочника Цикл
		
		СтрокаТЧ.ОтображаемоеСтароеЗначение = Объект.Предмет[СтрокаТЧ.ИмяРеквизита];
...
&НаКлиенте
Процедура ОбновитьСписокРеквизитов(Команда)
