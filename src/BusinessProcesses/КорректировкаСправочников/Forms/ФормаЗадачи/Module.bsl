...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Объект.ТочкаМаршрута = ТочкиМаршрута.ЗапросНаАкцептИзменений Тогда
		
		Элементы.ГруппаВыборВариантов.Видимость = Истина;
		
	ИначеЕсли Объект.ТочкаМаршрута = ТочкиМаршрута.ВнестиИзменения 
		Или Объект.ТочкаМаршрута = ТочкиМаршрута.ОповещениеОбОтклонении Тогда
...
Процедура ЗаполнитьРеквизитыСправочника()
	...
	РеквизитыСправочника.Очистить();
	
	Для каждого СтрокаТЧ Из Объект.БизнесПроцесс.РеквизитыСправочника Цикл
		
		СтрокаРеквизиты = РеквизитыСправочника.Добавить();
		ЗаполнитьЗначенияСвойств(СтрокаРеквизиты, СтрокаТЧ);
		СтрокаРеквизиты.СтароеЗначение = Объект.Предмет[СтрокаТЧ.ИмяРеквизита];
...
Процедура Принять(Команда)
	...
	Объект.ВыбранныйВариант = Элементы.Принять.Заголовок;
...
Процедура Отклонить(Команда)
	...
	Объект.ВыбранныйВариант = Элементы.Отклонить.Заголовок;
