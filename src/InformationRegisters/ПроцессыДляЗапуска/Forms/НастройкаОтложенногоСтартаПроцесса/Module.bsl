...
Процедура ЗаполнитьРеквизитыФормы()
	...
	РеквизитыПроцесса = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Параметры.БизнесПроцесс, "Стартован, Завершен");
...
Функция ФормаЗаполненаКорректно()
	...
	Если ОтложенныйСтартПроцесса И ДатаОтложенногоСтарта < ТекущаяДатаСервера Тогда
		ОбщегоНазначенияКлиентСервер.ДобавитьОшибкуПользователю(
			ОшибкиПользователю,
			"ДатаОтложенногоСтарта",
			НСтр("ru = 'Дата и время отложенного старта должны быть больше текущей даты.'"),
			"");
	КонецЕсли;
	Если ОтложенныйСтартПроцесса И ДатаОтложенногоСтарта > СрокИсполнения Тогда
		ОбщегоНазначенияКлиентСервер.ДобавитьОшибкуПользователю(
			ОшибкиПользователю,
			"ДатаОтложенногоСтарта",
			НСтр("ru = 'Дата и время отложенного старта должны быть меньше срока исполнения задания.'"),
			"");
	КонецЕсли;
