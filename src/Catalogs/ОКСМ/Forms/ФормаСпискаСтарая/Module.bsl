...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	МожноДобавлятьВСправочник = Справочники.ОКСМ.ЕстьПравоДобавления();
	...
	Элементы.СписокСоздать.Видимость = МожноДобавлятьВСправочник;
...
Процедура ПриОткрытии(Отказ)
	...
	Если ОткрытьФормуКлассификатора Тогда
		...
		ОткрытьФорму("Справочник.ОКСМ.Форма.Классификатор", ПараметрыОткрытия, ВладелецФормы);
		Отказ = Истина;
	КонецЕсли;
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	Если ИмяСобытия="Справочник.ОКСМ.Изменение" Тогда
...
Процедура ОткрытьКлассификатор(Команда)
	...
	ПараметрыОткрытия = Новый Структура;
	ПараметрыОткрытия.Вставить("ТекущаяСтрока", Элементы.Список.ТекущаяСтрока);
	ОткрытьФорму("Справочник.ОКСМ.Форма.Классификатор", ПараметрыОткрытия, Элементы.Список);
КонецПроцедуры
...
Процедура ВыбратьИзКлассификатора(Команда)
	...
	ПараметрыОткрытия.Вставить("РежимОткрытияОкна", РежимОткрытияОкна);
	ПараметрыОткрытия.Вставить("ТекущаяСтрока", Элементы.Список.ТекущаяСтрока);
	ОткрытьФорму("Справочник.ОКСМ.Форма.Классификатор", ПараметрыОткрытия, Элементы.Список,,,,, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура УстановитьОтборПересеченияСКлассификатором()
	...
	Запрос = Новый Запрос("
		...
		|	Классификатор КАК Классификатор
		|ПО
		|	ОКСМ.Код = Классификатор.Код
		|	И ОКСМ.Наименование = Классификатор.Наименование
		|");
	Запрос.УстановитьПараметр("Классификатор", Справочники.ОКСМ.ТаблицаКлассификатора());
