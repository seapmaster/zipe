...
//          * Ссылка             - СправочникаСсылка.ОКСМ - реквизит уже существующего элемента.
//
Функция СуществующийЭлемент() Экспорт
	...
	|	ПолноеНаименованиеСтраны КАК НаименованиеПолное,
	|	БуквенныйКодАльфа2       КАК КодАльфа2,
	|	БуквенныйКодАльфа3       КАК КодАльфа3,
	|	Ссылка             		 КАК Ссылка
	|ИЗ
	|	Справочник.ОКСМ
	|ГДЕ
