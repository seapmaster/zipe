...
Процедура ПроверитьПереводы(ИмяРеквизита = Неопределено)
	...
	Если ИмяРеквизита = Неопределено Тогда
		...
		МассивПереводовНаименованийДляСайта = Новый Массив;
		...
		Пока Выборка.Следующий() Цикл
			...
			Если Выборка.ИмяРеквизита = "НаименованиеДляСайта" Тогда
				
				МассивПереводовНаименованийДляСайта.Добавить(Выборка.Язык);	
		...
		Если МассивПереводовНаименованийДляСайта.Количество() > 0 Тогда
			
			МассивПереводовНаименованийДляСайта.Вставить(0, "Есть перевод на языки:");
			
			Команды.ПереводНаименованияДляСайта.Подсказка = СтрСоединить(МассивПереводовНаименованийДляСайта, Символы.ПС);
	...
	Иначе
		...
		Если РезультатЗапроса.Пустой() Тогда
			...
			Если ИмяРеквизита = "НаименованиеДляСайта" Тогда
				
				Команды.ПереводНаименованияДляСайта.Подсказка = "Нет переводов";	
...
&НаКлиенте
Процедура ПереводНаименованияДляСайта(Команда)
	...
	ПараметрыОткрытия = Новый Структура();
	ПараметрыОткрытия.Вставить("Владелец", Объект.Ссылка);
	ПараметрыОткрытия.Вставить("ИмяРеквизита", "НаименованиеДляСайта");
	ПараметрыОткрытия.Вставить("Значение", Объект.НаименованиеДляСайта);
