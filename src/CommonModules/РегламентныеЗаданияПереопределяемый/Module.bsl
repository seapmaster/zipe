...
Процедура УдалитьДублиПоставщиковПредметовСнабжения() Экспорт
	...
	Запрос.Текст 	= "ВЫБРАТЬ
	             	  ...
	             	  |ГДЕ
	             	  |	ВТ_ПредметыСнабжения.Количество > 1";
	
	Выборка 		= Запрос.Выполнить().Выбрать();
	
	Пока Выборка.Следующий() Цикл
		Справочники.КаталогПредметовСнабжения.СвенутьТаблицуПоставщиков(Выборка.ПредметСнабжения);
	КонецЦикла; // Пока Выборка.Следующий() Цикл
	
КонецПроцедуры // УдалитьДублиИзТЧ