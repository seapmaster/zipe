...
Процедура ПриОпределенииБизнесПроцессов(ПодключенныеБизнесПроцессы) Экспорт
	...
	ПодключенныеБизнесПроцессы.Вставить(Метаданные.БизнесПроцессы.ОтправкаВКСУНСИНаПоискПоКоду.ПолноеИмя(), "");
	ПодключенныеБизнесПроцессы.Вставить(Метаданные.БизнесПроцессы.ОтправкаВКСУНСИНаКлассификацию.ПолноеИмя(), "");
	ПодключенныеБизнесПроцессы.Вставить(Метаданные.БизнесПроцессы.ВзаимодействиеСРОЭ.ПолноеИмя(), "");
	ПодключенныеБизнесПроцессы.Вставить(Метаданные.БизнесПроцессы.УведомлениеОФормированииЗаявки.ПолноеИмя(), "");
	ПодключенныеБизнесПроцессы.Вставить(Метаданные.БизнесПроцессы.КорректировкаСправочников.ПолноеИмя(), "");
	ПодключенныеБизнесПроцессы.Вставить(Метаданные.БизнесПроцессы.РедактированиеЭлектроннойСтруктурыКорабля.ПолноеИмя(), "");
	ПодключенныеБизнесПроцессы.Вставить(Метаданные.БизнесПроцессы.ЗапросНаАктуализациюКаталогаПоставщика.ПолноеИмя(), "");
	ПодключенныеБизнесПроцессы.Вставить(Метаданные.БизнесПроцессы.ФормированиеЗаявки.ПолноеИмя(), "");
