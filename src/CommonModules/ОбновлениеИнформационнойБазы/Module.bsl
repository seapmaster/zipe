...
//                                                      В ключах соответствия могут лежать
//                                                    - пути к реквизитам шапки документа или реквизитам табличных частей, которые участвуют
//                                                          в соединениях с другими таблицами (в т.ч. неявных соединениях при обращении	"через точку").
//                                                          Процедуры проверяют блокировку данных этих таблиц обработчиками меньших очередей.
//                                                          Формат имен <ИмяРеквизита> или <ИмяТабличной>.<ИмяРеквизитаТабличнойЧасти>. 
//                                                          Например, "Контрагент" или "Товары.Номенклатура"
//                                                    - имена регистров, подчиненных регистратору. 
//                                                          Процедуры проверяют блокировку данных этих таблиц обработчиками регистров меньших очередей.
//                                                          Формат имен <КлассРегистра>.<ИмяРегистра>.
