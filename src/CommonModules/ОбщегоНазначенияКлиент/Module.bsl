...
Процедура ПерейтиПоСсылке(Ссылка) Экспорт
	...
	#Если ТолстыйКлиентОбычноеПриложение Тогда
		НачатьЗапускПриложения(Новый ОписаниеОповещения("ПерейтиПоСсылкеЗавершение", ЭтотОбъект), Ссылка);
	#Иначе
...
Процедура ПерейтиПоСсылкеЗавершение(КодВозврата, ДополнительныеПараметры) Экспорт
КонецПроцедуры // ПерейтиПоСсылкеЗавершение
