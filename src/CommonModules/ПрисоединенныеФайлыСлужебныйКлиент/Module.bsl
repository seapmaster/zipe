...
Процедура ПоместитьРедактируемыйФайлНаДискеВХранилищеРасширениеПредложеноЗавершение(Существует, ДополнительныеПараметры1) Экспорт
...
Процедура ВыбратьФайлНаДискеИПоместитьВХранилищеРасширениеПредложеноЗавершение(ВыбранныеФайлы, ДополнительныеПараметры1) Экспорт
...
Асинх Процедура ОткрытьКаталогСФайломОтветПолучен(РезультатВопроса, ДополнительныеПараметры) Экспорт
	...
	ПолноеИмяФайлаНаКлиенте = "";
	Ждать ПолучитьФайлВРабочийКаталог(
...
//
Асинх Процедура ПоместитьВыбранныеФайлыВХранилище(Знач ВыбранныеФайлы,
                                            Знач ВладелецФайла,
                                            ПрисоединенныеФайлыМассив,
	...
	Для Каждого ПолноеИмяФайла Из ВыбранныеФайлы Цикл
		...
		РезультатПомещения = ПоместитьФайлыНаСерверАсинх(,,ПомещаемыеФайлы, ИдентификаторФормы);
		...
		ПрисоединенныйФайл = ПрисоединенныеФайлыСлужебныйВызовСервера.ДобавитьФайл(
			...
			АдресВременногоХранилищаФайла,
			АдресВременногоХранилищаТекста,
			, ДопПараметры); // 22.03.2017 13:45:55 Савинов Александр 
...
Процедура ОткрытьФайлРасширениеПредложеноЗавершение1(Существует, ДополнительныеПараметры1) Экспорт
